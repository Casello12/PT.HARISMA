                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('sales_order_id') is-invalid @enderror" 
                                        ...
                                        @foreach($salesOrders as $salesOrder)
                                            <option value="{{ $salesOrder->id }}" {{ old('sales_order_id') == $salesOrder->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('tax_percentage') is-invalid @enderror" 
                                                   id="tax_percentage" name="tax_percentage" value="{{ old('tax_percentage', 11) }}" min="0" max="100" step="0.01">
